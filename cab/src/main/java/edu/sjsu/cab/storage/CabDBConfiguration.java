...
public class CabDBConfiguration {
	...
	public static void setJdbcDriver(String jdbcDriver) { CabDBConfiguration.jdbcDriver = jdbcDriver; }

	public static String getLocalDbUrl() {return localDbUrl;}

	public static void setLocalDbUrl(String localDbUrl) { CabDBConfiguration.localDbUrl = localDbUrl; }

	public static String getLocalDbUser() { return localDbUser;	}

	public static void setLocalDbUser(String localDbUser) {	CabDBConfiguration.localDbUser = localDbUser; }

	public static String getLocalDbPass() { return localDbPass;	}

	public static void setLocalDbPass(String localDbPass) {	CabDBConfiguration.localDbPass = localDbPass; }
}
